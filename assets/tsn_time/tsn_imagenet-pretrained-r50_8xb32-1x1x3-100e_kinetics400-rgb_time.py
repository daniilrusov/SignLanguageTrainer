...
test_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='E:\\ITMO\\CVProject\\mmaction_datasets\\time\\val_ann.txt',
...
test_evaluator = dict(
    ...
    'E:\\ITMO\\CVProject\\mmaction_datasets\\time\\label2id_mapping.json',
    type='F1Metric')
test_pipeline = [
    dict(io_backend='disk', type='DecordInit'),
    dict(
...
train_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='E:\\ITMO\\CVProject\\mmaction_datasets\\time\\train_ann.txt',
...
vis_backends = [
    dict(
        init_kwargs=dict(
            project_name='CVProject', task_name='train_time_package'),
...
work_dir = './work_dirs\\tsn_imagenet-pretrained-r50_8xb32-1x1x3-100e_kinetics400-rgb_time'
