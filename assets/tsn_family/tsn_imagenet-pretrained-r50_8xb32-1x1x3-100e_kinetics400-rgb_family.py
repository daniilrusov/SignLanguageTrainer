...
val_evaluator = dict(
    type="F1Metric",
    label2id_mapping_path="E:\ITMO\CVProject\mmaction_datasets\\family\\label2id_mapping.json",
)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(project_name="CVProject", task_name="train_family_package"),
    ),
]
