ann_file_train = 'E:\\ITMO\\CVProject\\mmaction_datasets\\animals\\train_ann.txt'
ann_file_val = 'E:\\ITMO\\CVProject\\mmaction_datasets\\animals\\val_ann.txt'
...
test_dataloader = dict(
    batch_size=8,
    dataset=dict(
        ann_file='E:\\ITMO\\CVProject\\mmaction_datasets\\animals\\val_ann.txt',
...
test_evaluator = dict(
    ...
    'E:\\ITMO\\CVProject\\mmaction_datasets\\animals\\label2id_mapping.json',
    type='F1Metric')
test_pipeline = [
    dict(io_backend='disk', type='DecordInit'),
    dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        'E:\\ITMO\\CVProject\\mmaction_datasets\\animals\\train_ann.txt',
...
vis_backends = [
    dict(
        init_kwargs=dict(
            project_name='CVProject', task_name='train_animals_package'),
...
work_dir = './work_dirs\\tsn_imagenet-pretrained-r50_8xb32-1x1x3-100e_kinetics400-rgb_animals'
