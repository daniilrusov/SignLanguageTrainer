...
task = Task.get_task(project_name='CVProject', task_name='lstm_family_subset')
task.mark_started()
...
all8th_folder = r"C:\Users\1\Desktop\archive\slovo\all8th_fam"
filtered_df=pd.read_excel(r'C:\Users\1\Desktop\archive\slovo\filtered_df_family.xlsx', engine = 'openpyxl')
...
all8th_folder = r"C:\Users\1\Desktop\archive\slovo\all8th_fam_test"
filtered_df2=pd.read_excel(r'C:\Users\1\Desktop\archive\slovo\filtered_df_family_test.xlsx', engine = 'openpyxl')
